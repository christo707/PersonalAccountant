...
/**
 * Servlet implementation class ExpenseCat
 */
@WebServlet("/ExpenseCat")
public class ExpenseCat extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		out.println("document.ExpenseCat.submit();");
		out.println("}");
		...
		out.println("<form name=\"ExpenseCat\" action=\"ExpenseCategoriesController\">");
		out.println("<table cellspacing=\"5\" width=\"100%\">");
		out.println("<tr>");
		out.println(
				"<th align = \"center\" colspan=\"3\" bgcolor=\"black\"><font color=\"white\"> Expense Categories</font></th>");
		out.println("</tr>");
		out.println("<tr>");
		...
		ArrayList<ExpensesCategories> catList = (ArrayList<ExpensesCategories>) request.getAttribute("expCatList");
		for (ExpensesCategories cat : catList) {
			out.println("<tr>");
			out.println("<td colspan = \"2\">" + cat.getExp_catname() + "</td>");
			...
			out.println(
					"<td ><input name=\"delete\" id=\"delete\" value=\"Delete!\" type=\"button\" onclick=\"del('"+cat.getExp_catid()+"');\" ></td>");
			out.println("</tr>");
		}
