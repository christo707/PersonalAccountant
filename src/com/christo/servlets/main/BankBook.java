...
public class BankBook extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		out.println("<form name=\"BankBook\" action=\"BankBookController\">");
		out.println("<table  width = \"600\" border=\"1px solid\" bordercolor = \"black\">");
		out.println("<tr height=\"50\">");
		out.println(
				"<th align = \"center\" colspan=\"3\"  bgcolor=\"black\"><font color=\"white\"> Bank Book</font></th>");
		out.println(
		...
		out.println("</tr>");
		int i = 1;
		ArrayList<BankBookPojo> bankbook = (ArrayList<BankBookPojo>) request.getAttribute("BankBook");
		for(BankBookPojo b : bankbook){
			out.println("<tr height=\"30\">");
			out.println(
