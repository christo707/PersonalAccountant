...
public class ExpensesCategories {
	...
	public ExpensesCategories(String exp_catname, String exp_catdetails, int userid) {
		super();
	...
	public ExpensesCategories(int exp_catid, String exp_catname, String exp_catdetails, int userid) {
		super();
	...
	public String toString() {
		return "ExpensesCategories [exp_catid=" + exp_catid + ", exp_catname=" + exp_catname + ", exp_catdetails="
